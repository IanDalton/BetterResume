...
const dictionaries: Record<Language, Dict> = {
  ...
  'confirm.clear': 'This will remove all locally saved progress. Continue?',
    ...
    'profile.upload.hint': 'PNG or JPG up to 5 MB.',
    ...
    'profile.editing.ready': 'Adjust your photo, then save it to upload.',
    'profile.editing.instructions': 'Drag to frame your photo, adjust the zoom, then choose its final shape. Every upload is resized automatically.',
    'profile.editing.zoom': 'Zoom',
    'profile.editing.gestureHint': 'Tip: drag to reposition and pinch or scroll to zoom like other photo pickers.',
  ...
  'confirm.clear': 'Esto eliminará el progreso local guardado. ¿Continuar?',
    ...
    'profile.upload.hint': 'PNG o JPG de hasta 5 MB.',
    ...
    'profile.editing.ready': 'Ajusta tu foto y guárdala para subirla.',
    'profile.editing.instructions': 'Arrastra la foto para encuadrarla, ajusta el zoom y elige su forma final. Todas las imágenes se redimensionan automáticamente.',
    'profile.editing.zoom': 'Zoom',
    'profile.editing.gestureHint': 'Consejo: arrastra para recolocar y pellizca o usa la rueda para hacer zoom, como en otras apps.',
