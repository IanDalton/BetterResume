...
const dictionaries: Record<Language, Dict> = {
  ...
  'confirm.clear': 'This will remove all locally saved progress. Continue?',
    ...
    'profile.editing.instructions': 'Drag the photo or use the sliders to center it and pick its final shape. All images are resized automatically.',
    'profile.editing.zoom': 'Zoom',
    'profile.editing.horizontal': 'Horizontal position',
    'profile.editing.vertical': 'Vertical position',
  ...
  'confirm.clear': 'Esto eliminará el progreso local guardado. ¿Continuar?',
    ...
    'profile.editing.instructions': 'Arrastra la foto o usa los controles para centrarla y elegir su forma final. Las imágenes se redimensionan automáticamente.',
    'profile.editing.zoom': 'Zoom',
    'profile.editing.horizontal': 'Posición horizontal',
    'profile.editing.vertical': 'Posición vertical',
