...
const dictionaries: Record<Language, Dict> = {
  ...
  'confirm.clear': 'This will remove all locally saved progress. Continue?',
    ...
    'profile.editing.instructions': 'Use the sliders to center your photo and pick its final shape. All images are resized automatically.',
  ...
  'confirm.clear': 'Esto eliminará el progreso local guardado. ¿Continuar?',
    ...
    'profile.editing.instructions': 'Usa los controles para centrar la foto y elegir su forma final. Las imágenes se redimensionan automáticamente.',
    'profile.editing.zoom': 'Zoom',
